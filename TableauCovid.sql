...
-- Went with abve to remove New Vaccinations for less confusion in visual (without Partition)
...
-- 6. Use CTE to Show Rolling People Vaccinated & Rolling Percentage Vaccinated
